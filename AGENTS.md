...
1. **Hasta toplantısı / Klinik notlar + işlem kodları:** Hasta görüşmesini dinler,
   ...
   hazırlar.
2. **Dikte / Periodontal çizelgeleme:** Hekimin perio muayene sırasında dikte
   ettiği cep derinliği, kanama, plak, furkasyon gibi değerleri diş/bölge bazlı
   periodontal chart taslağına çevirir.
...
**V1 demo/MVP slice:** Hasta toplantısı akışı ve Perio dikte akışı aynı ürün
çatısı altında görünür; Perio için kayıt sonrası yapılandırılmış chart taslağı
üretilir.
**V1 dışı (V2+):** Tam gerçek zamanlı perio charting, voice editing,
SGK/SUT kombinasyon & frekans kuralları, WhatsApp/hasta mesajı, röntgen/AI
teşhis, otomatik fatura.
